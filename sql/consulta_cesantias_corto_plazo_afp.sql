-- Consulta de cesantías corto plazo para BalancesAFPPatrimonios.
SELECT
...
WHERE eip.Tipo_Informe = 17
  ...
  AND e.Estado = 1
  AND pa.Tipo_Patrimonio = 5
  AND pa.Codigo_Patrimonio = 2
  AND p.Codigo IN (
      100000, 110000, 110500, 110505,
      110510, 110515, 110520
  )
  AND t.Fecha BETWEEN DATE '2026-05-01'
                  AND DATE '2026-05-31'
GROUP BY 1, 2, 3, 4, 5
ORDER BY 1, 3, 5;
