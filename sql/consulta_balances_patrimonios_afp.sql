-- Consulta de balances diarios de patrimonios AFP.
-- Aplicación: BalancesAFPPatrimonios.
-- Parámetros productivos: fecha inicial, fecha de corte y cuentas PUC.
-- Elimina comillas dobles de los nombres de las entidades y separa
-- Skandia Alternativo como una entidad lógica independiente.
