...
public class ExcelModeradoService {
    ...
    private void crearHojaRestot(
        ...
        addLabelValue(
                ...
                4,
                "Tipo Patrimonio",
                properties.getTipoPatrimonioModerado().toString()
        );
    ...
    private String crearHojaEntidad(
        ...
        ruleRow.createCell(1)
                .setCellValue(
                        "Moderado: Tipo Patrimonio "
                                + properties
                                .getTipoPatrimonioModerado()
                                + ", Código Patrimonio "
                                + properties
                                .getCodigoPatrimonioModerado()
                );
