...
public class ExcelCesantiasCortoPlazoService {
    ...
    private void crearHojaRestot(
        ...
        addLabelValue(
                ...
                4,
                "Tipo Patrimonio",
                properties.getTipoPatrimonioCesantiasCortoPlazo().toString()
        );
        ...
        addLabelValue(
                ...
                "Código Patrimonio",
                properties
                        .getCodigoPatrimonioCesantiasCortoPlazo()
                        .toString()
        );
    ...
    private String crearHojaEntidad(
        ...
        ruleRow.createCell(1)
                .setCellValue(
                        "Cesantías corto plazo: Tipo Patrimonio "
                                + properties
                                .getTipoPatrimonioCesantiasCortoPlazo()
                                + ", Código Patrimonio "
                                + properties
                                .getCodigoPatrimonioCesantiasCortoPlazo()
                );
