...
public class ExcelRetiroProgramadoService {
    ...
    private void crearHojaRestot(
        ...
        addLabelValue(
                ...
                4,
                "Tipo Patrimonio",
                properties.getTipoPatrimonioRetiroProgramado().toString()
        );
        ...
        addLabelValue(
                ...
                "Código Patrimonio",
                properties
                        .getCodigoPatrimonioRetiroProgramado()
                        .toString()
        );
    ...
    private String crearHojaEntidad(
        ...
        ruleRow.createCell(1)
                .setCellValue(
                        "Retiro Programado: Tipo Patrimonio "
                                + properties
                                .getTipoPatrimonioRetiroProgramado()
                                + ", Código Patrimonio "
                                + properties
                                .getCodigoPatrimonioRetiroProgramado()
                );
