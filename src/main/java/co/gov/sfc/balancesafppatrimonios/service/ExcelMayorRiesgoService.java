...
public class ExcelMayorRiesgoService {
    ...
    private void crearHojaRestot(
        ...
        addLabelValue(
                ...
                4,
                "Tipo Patrimonio",
                properties.getTipoPatrimonioMayorRiesgo().toString()
        );
        ...
        addLabelValue(
                ...
                "Código Patrimonio",
                properties
                        .getCodigoPatrimonioMayorRiesgo()
                        .toString()
        );
    ...
    private String crearHojaEntidad(
        ...
        ruleRow.createCell(1)
                .setCellValue(
                        "Mayor Riesgo: Tipo Patrimonio "
                                + properties
                                .getTipoPatrimonioMayorRiesgo()
                                + ", Código Patrimonio "
                                + properties
                                .getCodigoPatrimonioMayorRiesgo()
                );
