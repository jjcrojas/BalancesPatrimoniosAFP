...
public class ExcelConservadorService {
    ...
    private void crearHojaRestot(
        ...
        addLabelValue(
                ...
                4,
                "Tipo Patrimonio",
                properties.getTipoPatrimonioConservador().toString()
        );
        ...
        addLabelValue(
                ...
                "Código Patrimonio",
                properties
                        .getCodigoPatrimonioConservador()
                        .toString()
        );
    ...
    private String crearHojaEntidad(
        ...
        ruleRow.createCell(1)
                .setCellValue(
                        "Conservador: Tipo Patrimonio "
                                + properties
                                .getTipoPatrimonioConservador()
                                + ", Código Patrimonio "
                                + properties
                                .getCodigoPatrimonioConservador()
                );
