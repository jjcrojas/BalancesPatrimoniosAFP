...
public class ExcelCesantiasTotalService {
    ...
    private void crearHojaRestot(
        ...
        addLabelValue(
                ...
                "Código Patrimonio",
                properties
                        .getCodigosPatrimonioCesantiasTotal()
                        .toString()
        );
    ...
    private String crearHojaEntidad(
        ...
        ruleRow.createCell(1)
                .setCellValue(
                        "Cesantías total: Tipo Patrimonio "
                                + properties
