...
public class ExcelCesantiasLargoPlazoService {
    ...
    private void crearHojaRestot(
        ...
        addLabelValue(
                ...
                4,
                "Tipo Patrimonio",
                properties.getTipoPatrimonioCesantiasLargoPlazo().toString()
        );
    ...
    private String crearHojaEntidad(
        ...
        ruleRow.createCell(1)
                .setCellValue(
                        "Cesantías largo plazo: Tipo Patrimonio "
                                + properties
