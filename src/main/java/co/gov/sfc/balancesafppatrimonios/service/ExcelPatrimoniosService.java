...
public class ExcelPatrimoniosService {
    ...
    public GeneratedReport generar(
        ...
        try (Workbook workbook = new XSSFWorkbook();
             ...
             * después en las fórmulas de la hoja restot.
             */
            ...
            /*
             * restot se presenta como primera hoja.
             */
            workbook.setSheetOrder("restot", 0);
    ...
    private void crearHojaRestot(
        ...
        Sheet sheet = workbook.createSheet("restot");
        ...
        addLabelValue(
                ...
                4,
                "Tipo Patrimonio",
                properties.getTipoPatrimonio().toString()
        );
        ...
        addLabelValue(
                ...
                styles,
                5,
                "Patrimonios ordinarios",
                properties
                        .getCodigosPatrimonioObligatorio()
                        .toString()
        );
        ...
        addLabelValue(
                ...
                "Skandia Alternativo",
                properties
                        .getCodigosPatrimonioSkandiaAlternativo()
                        .toString()
        );
         ...
         * fila de datos de restot. Por eso MATCH no encontraba las
    ...
    private String crearHojaEntidad(
        ...
        ruleRow.createCell(1)
                .setCellValue(
                        entidad.virtual()
                                ? "Skandia Alternativo: patrimonios "
                                + properties
                                .getCodigosPatrimonioSkandiaAlternativo()
                                : "Patrimonios obligatorios ordinarios"
                );
    ...
    private String crearFormulaValorDia(
         ...
         * D:AH = D1:D31
         *
         * E9 de restot contiene el número de día seleccionado.
         */
        return "IFERROR("
                + "INDEX('"
                + hojaEscapada
